...
import (
	...
	"github.com/xiazeyin/fabric-sdk-go-gm/internal/github.com/xiazeyin/fabric-gm/sdkpatch/cryptosuitebridge"
)
...
func ComputeSM3(data []byte) (hash []byte) {
	hash, err := cryptosuitebridge.GetDefault().Hash(data, cryptosuitebridge.GetSM3Opts())
	if err != nil {
		panic(errors.Errorf("Failed computing SM3 on [% x]", data))
	}
	return
}
